...
You could stop after these definitions! Just look at the Lerray-Serre spectral sequence.\\
...
A (homology) spectral sequence collapses at $E^r(r \geq 1)$ if there is exactly one nonzero row or column in the lattice $\left\{E_{p q}^r\right\}$.\\
